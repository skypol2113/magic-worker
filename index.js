...
const FIELD_LABELS = {
  ...
  price: { en: 'Price?', ru: 'Цена?', zh: '价格?', es: '¿Precio?', ar: 'السعر؟', de: 'Preis?', fr: 'Prix ?', ja: '価格?' },
  location: { en: 'Location?', ru: 'Место?', zh: '地点?', es: '¿Ubicación?', ar: 'الموقع؟', de: 'Ort?', fr: 'Lieu ?', ja: '場所?' },
  date: { en: 'Date?', ru: 'Дата?', zh: '日期?', es: '¿Fecha?', ar: 'التاريخ؟', de: 'Datum?', fr: 'Date ?', ja: '日付?' },
  time: { en: 'Time?', ru: 'Время?', zh: '时间?', es: '¿Hora?', ar: 'الوقت؟', de: 'Zeit?', fr: 'Heure ?', ja: '時間?' },
  duration: { en: 'How many days?', ru: 'Сколько дней?', zh: '多少天?', es: '¿Cuántos días?', ar: 'كم يوما؟', de: 'Wie viele Tage?', fr: 'Combien de jours ?', ja: '何日間?' },
  // People/capacity
  peopleCount: { en: 'How many people?', ru: 'Сколько человек?', zh: '多少人?', es: '¿Cuántas personas?', ar: 'كم شخص؟', de: 'Wie viele Personen?', fr: 'Combien de personnes ?', ja: '何人?' },
  seats: { en: 'Seats?', ru: 'Мест?', zh: '座位?', es: '¿Asientos?', ar: 'المقاعد؟', de: 'Sitzplätze?', fr: 'Places ?', ja: '席数?' },
  capacity: { en: 'Capacity?', ru: 'Вместимость?', zh: '容量?', es: '¿Capacidad?', ar: 'السعة؟', de: 'Kapazität?', fr: 'Capacité ?', ja: '定員?' },
  quantity: { en: 'Quantity?', ru: 'Количество?', zh: '数量?', es: '¿Cantidad?', ar: 'الكمية؟', de: 'Menge?', fr: 'Quantité ?', ja: '数量?' },
  // Budget/money
  budget: { en: 'Budget?', ru: 'Бюджет?', zh: '预算?', es: '¿Presupuesto?', ar: 'الميزانية؟', de: 'Budget?', fr: 'Budget ?', ja: '予算?' },
  pricePerHour: { en: 'Price/hour?', ru: 'Цена/час?', zh: '每小时价格?', es: '¿Precio/hora?', ar: 'السعر/ساعة؟', de: 'Preis/Stunde?', fr: 'Prix/heure ?', ja: '1時間あたり?' },
  currency: { en: 'Currency?', ru: 'Валюта?', zh: '货币?', es: '¿Moneda?', ar: 'العملة؟', de: 'Währung?', fr: 'Devise ?', ja: '通貨?' },
  // Item condition/specs
  condition: { en: 'Condition?', ru: 'Состояние?', zh: '状况?', es: '¿Estado?', ar: 'الحالة؟', de: 'Zustand?', fr: 'État ?', ja: '状態?' },
  brand: { en: 'Brand?', ru: 'Бренд?', zh: '品牌?', es: '¿Marca?', ar: 'العلامة التجارية؟', de: 'Marke?', fr: 'Marque ?', ja: 'ブランド?' },
  year: { en: 'Year?', ru: 'Год?', zh: '年份?', es: '¿Año?', ar: 'السنة؟', de: 'Jahr?', fr: 'Année ?', ja: '年式?' },
  model: { en: 'Model?', ru: 'Модель?', zh: '型号?', es: '¿Modelo?', ar: 'الطراز؟', de: 'Modell?', fr: 'Modèle ?', ja: '型番?' },
  size: { en: 'Size?', ru: 'Размер?', zh: '尺寸?', es: '¿Tamaño?', ar: 'الحجم؟', de: 'Größe?', fr: 'Taille ?', ja: 'サイズ?' },
  color: { en: 'Color?', ru: 'Цвет?', zh: '颜色?', es: '¿Color?', ar: 'اللون؟', de: 'Farbe?', fr: 'Couleur ?', ja: '色?' },
  // Learning/teaching
  schedule: { en: 'Schedule?', ru: 'Расписание?', zh: '时间表?', es: '¿Horario?', ar: 'الجدول الزمني؟', de: 'Zeitplan?', fr: 'Horaire ?', ja: 'スケジュール?' },
  level: { en: 'Level?', ru: 'Уровень?', zh: '水平?', es: '¿Nivel?', ar: 'المستوى؟', de: 'Niveau?', fr: 'Niveau ?', ja: 'レベル?' },
  subject: { en: 'Subject?', ru: 'Предмет?', zh: '科目?', es: '¿Materia?', ar: 'الموضوع؟', de: 'Fach?', fr: 'Sujet ?', ja: '科目?' },
  language: { en: 'Language?', ru: 'Язык?', zh: '语言?', es: '¿Idioma?', ar: 'اللغة؟', de: 'Sprache?', fr: 'Langue ?', ja: '言語?' },
  // Travel/rideshare
  from: { en: 'From?', ru: 'Откуда?', zh: '从哪里?', es: '¿Desde?', ar: 'من أين؟', de: 'Von?', fr: 'De ?', ja: '出発地?' },
  to: { en: 'To?', ru: 'Куда?', zh: '到哪里?', es: '¿Hasta?', ar: 'إلى أين؟', de: 'Nach?', fr: 'Vers ?', ja: '目的地?' },
  vehicle: { en: 'Vehicle?', ru: 'Транспорт?', zh: '车辆?', es: '¿Vehículo?', ar: 'المركبة؟', de: 'Fahrzeug?', fr: 'Véhicule ?', ja: '乗り物?' },
  luggageAllowed: { en: 'Luggage?', ru: 'Багаж?', zh: '行李?', es: '¿Equipaje?', ar: 'الأمتعة؟', de: 'Gepäck?', fr: 'Bagages ?', ja: '荷物?' },
  itinerary: { en: 'Itinerary?', ru: 'Маршрут?', zh: '行程?', es: '¿Itinerario?', ar: 'المسار؟', de: 'Reiseplan?', fr: 'Itinéraire ?', ja: '旅程?' },
  // Housing
  rooms: { en: 'Rooms?', ru: 'Комнат?', zh: '房间数?', es: '¿Habitaciones?', ar: 'الغرف؟', de: 'Zimmer?', fr: 'Pièces ?', ja: '部屋数?' },
  area: { en: 'Area?', ru: 'Площадь?', zh: '面积?', es: '¿Área?', ar: 'المساحة؟', de: 'Fläche?', fr: 'Surface ?', ja: '面積?' },
  accommodation: { en: 'Accommodation?', ru: 'Жильё?', zh: '住宿?', es: '¿Alojamiento?', ar: 'السكن؟', de: 'Unterkunft?', fr: 'Hébergement ?', ja: '宿泊?' },
  // Tech/specs
  ram: { en: 'RAM?', ru: 'ОЗУ?', zh: '内存?', es: '¿RAM?', ar: 'الذاكرة العشوائية؟', de: 'RAM?', fr: 'RAM ?', ja: 'RAM?' },
  storage: { en: 'Storage?', ru: 'Память?', zh: '存储?', es: '¿Almacenamiento?', ar: 'التخزين؟', de: 'Speicher?', fr: 'Stockage ?', ja: 'ストレージ?' },
  // Service/event
  availability: { en: 'When available?', ru: 'Когда доступно?', zh: '何时可用?', es: '¿Cuándo disponible?', ar: 'متى متاح؟', de: 'Wann verfügbar?', fr: 'Quand disponible ?', ja: '利用可能?' },
  contact: { en: 'Contact?', ru: 'Контакт?', zh: '联系方式?', es: '¿Contacto?', ar: 'جهة الاتصال؟', de: 'Kontakt?', fr: 'Contact ?', ja: '連絡先?' },
};
